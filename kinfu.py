...
from kinfu.fusion import TSDFVolumeTorch
from dataset.tum_rgbd import TUMDataset, TUMDatasetOnline
from kinfu.tracker import ICPTracker
from kinfu.utils import load_config, get_volume_setting, get_time
...
if __name__ == "__main__":
    ...
    dataset = TUMDataset(os.path.join(args.data_root), device, near=args.near, far=args.far, img_scale=1)
